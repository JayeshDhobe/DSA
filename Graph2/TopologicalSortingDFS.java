...
public class TopologicalSortingDFS {
    ...
    public static void topSort(ArrayList<Edge>[] graph) { // time comp O(V+E) and Space comp O(V)
        boolean vis[] = new boolean[graph.length];
        Stack<Integer> s = new Stack<>(); // implicit/inbuilt Stack
    ...
    public static void main(String[] args) {
        ...
        createGraph(graph);
        topSort(graph); // Topological sort order 5 4 2 3 1 0
    }
}
